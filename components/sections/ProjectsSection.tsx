...
const ProjectsSection = () => {
  ...
  // Custom render function for project cards - optimized for 600px height
  const renderProjectCard = (item: CarouselItem) => (
    <div className="grid grid-cols-2 gap-6 h-full p-6">
      ...
      <div className="flex flex-col justify-center py-8 pr-8">
        ...
        <p className="text-gray-400 text-base mb-4 leading-relaxed line-clamp-3">{item.description}</p>
        ...
        <div className="flex gap-4">
          {item.github && (
            <a
              ...
              className="px-5 py-2.5 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium flex items-center gap-2"
